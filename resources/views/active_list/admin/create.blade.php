...
@section('content')
    ...
    <div class="container mb-5 m-auto mt-5 ">
        <div class="row ">
            ...
            <div class="col-md-2 ">
                <button type="button" class="btn"> <a href="/admin/active-list">
        ...
        <form action="/admin/active-list" method="post">
            @csrf
            <div class="row py-4">
                <div class="col-md-2"> </div>
                <div class="col-md-8 border rounded">
                    <table class="table table-borderless w-max">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="date" name="receiveDate" class="form-control d-inline" style="width:50%"
                                        id="receiveDate">
                                    <div id="hidden_div" style="display:none;">
                                        <input type="date" class="form-control d-inline" style="width:45%"
