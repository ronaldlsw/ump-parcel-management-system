    ...
    <div class="container center py-5">
            ...
            <div class="col-md-2 pt-2 ">
                <div class="d-flex justify-content-end">
                    <button class="btn-md btn-primary"><a style="text-decoration:none;" class="text-light"
                            href="/admin/active-list/report">
                            <i class="fas fa-file-alt fa-md"></i>
                        </a></button>
                    <div class="pl-2">
                        <button type="button" class="btn-md btn-primary text-light">
                            <a style="text-decoration:none;" class="text-light" href="/admin/active-list/create"><i
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table id="itemList" class="table table-striped table-bordered text-center"
                            ...
                            <tr>
                                ...
                                @if ($parcel->collect_date == null)
                                    <td> <button type="button" class="btn btn-primary"><a class="text-light"
                                                href="/admin/active-list/updateC/{{ $parcel->p_id }}">Update</a></button>
                                    </td>
                                @else
                                ...
                                <td>
                                    <div id="parent" style="width:100%">
                                        <a href="/admin/active-list/show/{{ $parcel->p_id }}" class="btn">
                                            <button type="button" class="btn btn-primary"><i class="fas fa-cog fa-sm"></i>
                                            </button>
                                        </a>


                                        <a href="/admin/active-list/delete/{{ $parcel->p_id }}">
