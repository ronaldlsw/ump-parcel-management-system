                        ...
                        <tbody>
                            @foreach ($complains as $comp)
                                <tr>
                                    ...
                                    <td>{{ $comp->c_status }}</td>
                                    <td>
                                        <a href="/comp_list/oshow/{{ $comp->c_id }}" class="btn"><button type="button"
                ...
                <table class="table table-borderless table">
                            <tbody>
                                    ...
                                    <tr>
                                     ...
                                     <th></th>
                                     <th></th>
                                     <th> <a href="/comp_list/oreport/" ><button class="btn-lg btn-primary text-light" >Generate Report</button></a></th>
                                    </tr>
                                    </tbody>
                    </table>
