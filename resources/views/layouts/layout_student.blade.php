            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/student" aria-current="page">Home</a>
                        </li>
                        <li class="nav-item">
                        <div class="dropdown">
                            <a class="nav-link"  href="/Good-list" aria-current="page">Goods List</a>
                            <div class="dropdown-content">
                                <a href="/Good-list">View Goods List</a>
                                <a href="/Good-list/report">View Goods List Report</a>
                            </div>
                        </div>
                        </li>
                        <li class="nav-item">
                        <div class="dropdown">
                            <a class="nav-link" href="/comp_list" aria-current="page">Complaint List</a>
                            <div class="dropdown-content">
                                <a href="/comp_list">View Complaint List</a>
                                <a href="/comp_list/create">Make Complaint</a>
                            </div>
                        </div>
                        </li>
                    </ul>
